			...
			<tbody>
				...
				foreach ($pembayaran->result_array() as $row) {
					...
					<tr>
						...
						<td><?= $row['dtl_status']?>/ <?= $row['dtl_bank']?> / <?= $row['dtl_jenis_bayar']?></td>
						<td class="text-left" style="width: 135px;">
							<?php
				...
				<tr>
					...
					<td class="text-right">Total Pengembalian Pembayaran &nbsp;</td>
					<td class="text-left" style="width: 135px;">
						<?= "Rp. ".number_format($data['dtl_jml_bayar'] - $data['trans_total'], 0).",-"; ?>
					</td>
				</tr>
			</tbody>
		</table>
