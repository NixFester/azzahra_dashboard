...
<div class="content">
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-6 mb-6 shadow-sm">
        ...
        <div class="flex items-center text-sm text-gray-500 mt-4">
            <a href="<?= site_url('Admin') ?>" class="hover:text-blue-600 text-gray-500">Dashboard</a>
            <i data-feather="chevron-right" class="w-4 h-4 mx-2 text-gray-400"></i>
            <a href="<?= site_url('Voucher') ?>" class="hover:text-blue-600 text-gray-500">Voucher Discount</a>
            <i data-feather="chevron-right" class="w-4 h-4 mx-2 text-gray-400"></i>
            <span class="text-blue-600 font-medium">Tambah Baru</span>
        </div>
    </div>

    <form action="<?= site_url('Voucher/save') ?>" method="POST" enctype="multipart/form-data" id="voucher-form">
    ...
    <div class="intro-y flex justify-end mt-6">
        <div class="flex gap-3">
            <a href="<?= site_url('Voucher') ?>" class="btn btn-outline-secondary px-6">
