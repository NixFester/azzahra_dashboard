...
<head>
    <meta charset="utf-8">
    <title>Laporan Harian Customer Service</title>
    <style>
        body {
...
<div class="header">
    ...
    <p>Customer Service: <?= $cs['kry_nama'] ?></p>
</div>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center"><?= $jml_mandiri->num_rows(); ?></td>
...
<table>
    ...
    <tbody>
        ...
        <?php else: ?>
            <tr>
                <td colspan="7" class="text-center">Tidak ada pembayaran DP hari ini</td>
            </tr>
        <?php endif; ?>
...
<table>
    ...
    <tbody>
        ...
        <?php else: ?>
            <tr>
                <td colspan="7" class="text-center">Tidak ada pembayaran pelunasan hari ini</td>
            </tr>
        <?php endif; ?>
