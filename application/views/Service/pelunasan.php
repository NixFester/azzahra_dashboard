                        ...
                        <div class="p-5">
                        	<div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
                        		<div class="col-span-12 lg:col-span-8">
                                 ...
                                 <div class="flex mt-5">
                         <a href="<?= site_url('Service/return_pembayaran/'.$proses['trans_kode'])?>" class="tombol-return" data-nama="<?= $proses['cos_nama']; ?>">
                            <button class="button w-32 text-white bg-theme-6 shadow-md ml-auto block" style="width: 580px;">Return Pembayaran</button>
                         </a>
                     </div>
                        			</div>
        ...
        <div class="modal__content modal__content--xl p-10 intro-y box sm:py-15 mt-2">
        	...
        	<form id="tambah-tindakan-form" method="post" action="<?= site_url('Service/tambah_tindakan')?>">
        		<div class="px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200">
        			...
        			<input type="hidden" name="redirect_page" value="pelunasan">
        		</div>
        		<div class="px-5 py-3 text-right border-t border-gray-200">
        			<button type="button" data-dismiss="modal" class="button w-20 border text-gray-700 mr-1">Cancel</button>
        			<button type="submit" class="button w-20 bg-theme-1 text-white">Simpan</button>
