...
<!-- <?= $row['cos_hp']; ?> -->
				...
				<div class="nav-tabs flex flex-col sm:flex-row justify-center lg:justify-start"> 
					...
					<a data-toggle="tab" data-target="#konf-kelket" role="button" class="py-4 sm:mr-8">Keluhan & Keterangan</a> 				<a data-toggle="tab" data-target="#sparepart" role="button" class="py-4 sm:mr-8">Detail Sparepart</a> 				</div>
			</div>
