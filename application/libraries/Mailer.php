...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'nurulkhikam98@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Azzahra'; // Isikan dengan nama pengirim
    protected $password = 'namaqkhikam'; // Isikan dengan password email pengirim
